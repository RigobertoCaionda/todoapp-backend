...
|
*/
export const plugins: Required<Config>['plugins'] = [assert(), runFailedTests(), apiClient(), expect()]
...
export const runnerHooks: Pick<Required<Config>, 'setup' | 'teardown'> = {
  setup: [
    ...
    () => TestUtils.db().migrate(), // Adicionado por mim
    () => TestUtils.db().seed() // Adicionado por mim
  ],
  teardown: [],
}
